...
public class BridgeViewlet {
	...
	public void DeleteCommand( ITestContext context) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys(FinalBridgeName);
		Thread.sleep(1000);
	...
	public static void AddToFavoriteViewlet(String FavoriteViewletName, ITestContext context) throws InterruptedException
	{
    	...
    	//Store the Bridge Name into string
		String BridgeName=driver.findElement(By.xpath("//div[1]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper/datatable-body-row/div[2]/datatable-body-cell["+ Name_Index +"]/div/span")).getText();
	...
	public static void AddToFavoriteForMultipleBridges(String FavoriteViewletName, ITestContext context) throws InterruptedException
	{
		...
		//Store the Bridge names into string
		String BridgeName2=driver.findElement(By.xpath("//div[1]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[2]/datatable-body-row/div[2]/datatable-body-cell["+ Name_Index +"]/div/span")).getText();
		String BridgeName3=driver.findElement(By.xpath("//div[1]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[3]/datatable-body-row/div[2]/datatable-body-cell["+ Name_Index +"]/div/span")).getText();
